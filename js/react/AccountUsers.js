            ...
            return (
                <div className="row">
                        ...
                        <form className="form-horizontal" onSubmit={this.handleSubmit}>
                            <fieldset id="account">
                                ...
                                <div className="form-group required">
                                    <label className="col-sm-2 control-label" htmlFor="first_name">Имя</label>
                                ...
                                <div className="form-group required">
                                    <label className="col-sm-2 control-label" htmlFor="email_address">E-Mail</label>
                                    <div className="col-sm-10">
                                ...
                                <div className="form-group required">
                                    <label className="col-sm-2 control-label" htmlFor="phone_number">Телефон</label>
                                    <div className="col-sm-10">
                                ...
                                <div className="form-group" style={{ display: (this.state.value_discont > 0) ? 'block' : 'none' }}><label className="col-sm-8">Ваша скидка: {this.state.value_discont}%</label></div>
                            </fieldset>
                    ...
                    <div className="messages">
                        ...
                        <form className="form-horizontal" onSubmit={this.handleSubmitPwd}>
                            <fieldset id="account">
                                <legend>Пароль</legend>

                                <div className="form-group required">
                                    <label className="col-sm-4 control-label" htmlFor="first_password">Старый пароль</label>
                                ...
                                <div className="form-group required">
                                    <label className="col-sm-4 control-label" htmlFor="second_password">Новый пароль</label>
                                    <div className="col-sm-8">
                                ...
                                <div className="form-group required">
                                    <label className="col-sm-4 control-label" htmlFor="third_password">Повторите новый пароль</label>
                                    <div className="col-sm-8">
                            ...
                            <div className="form-group col-sm-8"><button id="sendOrder" type="submit" className="btn essence-btn" style={{ display: this.state.visibleSendBtn2 ? 'block' : 'none' }}>Сменить</button>
                                <div id="submit_img"  style={{ display: this.state.visibleSendBtn2 ? 'none' : 'block' }}>
                                    <img src="/catalog/view/theme/zemez894/image/litt-loader.gif" width="70" height="70"/></div>
                            </div>
                    ...
                    {/*<div className="col-8 col-sm-6 col-md-6">
                        ...
                        <form className="needs-validation form-horizontal" onSubmit={this.handleSubmit}>
                            <fieldset>
                                ...
                                <div className="col-12 mb-3 form-group" style={{ display: (this.state.value_discont > 0) ? 'block' : 'none' }}>
                    ...
                    <div className="col-4 col-sm-6 col-md-6">
                        ...
                        <form className="needs-validation form-horizontal" onSubmit={this.handleSubmitPwd}>
                            <fieldset>
                                <legend>Пароль</legend>
                                <div className="col-12 mb-3 form-group">
