        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data.code===0)
                {
                    ...
                    $('#pull-right').html(`<a href="/users/account"><i class="material-icons-vpn_key"></i><span>${data.name}</span></a>`);
                ...
                }else
                {
                    ...
                    $('#pull-right').html(`<a href="/login"><i class="material-icons-vpn_key"></i><span>Вход</span></a>`);
