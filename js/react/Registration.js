                    ...
                    <div id="content" className="col-sm-12">
                        ...
                        <form className="needs-validation form-horizontal" onSubmit={this.handleSubmit}>
                            ...
                            <fieldset>
                                ...
                                <div className="form-group required">
                                    <label className="col-sm-2 control-label" htmlFor="first_password">Пароль</label>
                                    <div className="col-sm-10">
                                    <input type="password"  className={(!this.state.pwdDiff) ? "form-control" : "form-control is-invalid"} id="first_password" name="first_password" required onChange={(e) => this.changeP1(e)} />
                                    </div>
                                </div>
                                <div className="form-group required">
                                    <label className="col-sm-2 control-label" htmlFor="second_password">Повторите пароль</label>
                                    <div className="col-sm-10">
                                    <input type="password" className={(!this.state.pwdDiff) ? "form-control" : "form-control is-invalid"} id="second_password" name="second_password" required onChange={(e) => this.changeP2(e)} />
                                    </div>
                                </div>
                            </fieldset>
...
ReactDOM.render(<Registration />, document.getElementById('account-register'));