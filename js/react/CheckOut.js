                ...
                <div className="row">
                    ...
                    <div className="col-12 col-sm-6 col-md-6">
                        ...
                        <div className="col-12 mb-3 required">
                            <label className="control-label" htmlFor="first_name">Имя Фамилия</label>
                        ...
                        <div className="col-12 mb-3 required">
                            <label className="control-label" htmlFor="phone_number">Телефон</label>
                        ...
                        <div className="col-12 mb-3 required">
                            <label className="control-label" htmlFor="email_address">Email</label>
